...
<head>
    ...
    <link rel="stylesheet" href="../css/iniciodsesionT.css">
...
<body>
    <main>
        <div class="contenedor__todo">
            ...
            <div class="registros">
                 <form action="../php/validacionT.php" method="POST" class="inicioDs">
    ...
    <script src="../js/modules/animacionformulariosT.js"></script>
</body>
</html>