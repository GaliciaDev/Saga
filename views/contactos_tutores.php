	...
	<header>
		<nav>
            <ul class="menu">
                ...
                <li class="dropdown">
                    <button class="dropbtn">Opciones Administrativas</button>
                    <div class="dropdown-content">
                      <a href="registro_alumnos.html">Alumnos</a>
                      <a href="registro_docentes.html">Docentes</a>
                      <a href="registro_administrativo.html">Administrativo</a>
                    </div>
                </li> 
